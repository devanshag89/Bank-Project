...
{
    $message='Not sufficient ammount';
}
$message1='';
if(isset($_SESSION['done']))
{
    $message1='Sended Successfully';
}
   ...
   <section class="">
    ...
    <h2 style=" color : green"><?php echo $message1; ?></h2>
        ...
        <div class="flex flex-col w-full max-w-md p-10 mx-auto my-6 transition duration-500 ease-in-out transform bg-white rounded-lg md:mt-0">
            <div class="mt-8">
                <div class="mt-6">
                    <form action="transfer_db.php" method="POST" class="space-y-6">
                    
                        
                            
                            <label for="email" class="block text-sm font-medium text-neutral-600"> Enter Transfer Amount </label>
                            <div class="mt-1">
                                <input id="email" name="money" type="float" placeholder="Enter Transfer Amount" class="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300" fdprocessedid="nn6ekf">
                            </div>
                            <label for="email" class="block text-sm font-medium text-neutral-600"> Enter Receiver Email </label>
                            <div class="mt-1">
                                <input id="email" name="remail" type="email" placeholder="Enter Email" class="block w-full px-5 py-3 text-base text-neutral-600 placeholder-gray-300 transition duration-500 ease-in-out transform border border-transparent rounded-lg bg-gray-50 focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300" fdprocessedid="nn6ekf">
                            </div>
